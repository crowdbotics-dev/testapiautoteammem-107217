...
## Project Structure
    ...
    ├── testapiautoteammem_107217  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammem_107217`
...
2. Clone this repo and `cd testapiautoteammem_107217`
